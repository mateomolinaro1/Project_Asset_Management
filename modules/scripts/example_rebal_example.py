...
portfolio = EqualWeightingScheme(returns=data_manager.aligned_returns,
                                 signals=cs_mom.signals,
                                 rebal_periods=6,
                                 portfolio_type='long_only'
                                 )
portfolio.compute_weights()
portfolio.rebalance_portfolio(transaction_cost_bp=10)

# 4 - Backtesting
backtest =  Backtest(returns=portfolio.returns_after_fees,
...
# # Affiche tout sans limite
# pd.set_option('display.max_rows', 10)
# pd.set_option('display.max_columns', 6)
# pd.set_option('display.width', None)  # Ajuste pour pas couper les lignes
