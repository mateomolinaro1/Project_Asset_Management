...
# Data Downloading - factors
# file_path = os.path.join(r"C:\Users\mateo\Code\AM\Project_Asset_Management", "data", "mkt.xlsx")
data_source_factors = ExcelDataSource(file_path=r".\data\mkt.xlsx", sheet_name="data")
...
cs_mom = CrossSectionalPercentiles(prices=data_manager.cleaned_data,
                                   ...
                                   signal_function=Momentum.rolling_idiosyncratic_sharpe_ratio_momentum,
                                   signal_function_inputs={'df_assets': data_manager.returns,
                                                           'df_factors': data_manager_factors.returns,
                                                           'nb_period': 12,
                                                           'rolling_window_momentum': 12+1,
                                                           'rolling_window_sharpe_ratio': 12+1,
                                                           'rolling_window_idiosyncratic': 12+1,
